...
execute if block ^-0.5 ^-2 ^ minecraft:diamond_block if block ^-1.5 ^-2 ^ minecraft:diamond_block if block ^0.5 ^-2 ^ minecraft:diamond_block if block ^1.5 ^-2 ^ minecraft:diamond_block if block ^1.5 ^-1 ^ minecraft:diamond_block if block ^-1.5 ^-1 ^ minecraft:diamond_block if block ^1.5 ^ ^ minecraft:diamond_block if block ^-1.5 ^ ^ minecraft:diamond_block if block ^1.5 ^1 ^ minecraft:diamond_block if block ^-1.5 ^1 ^ minecraft:diamond_block if block ^1.5 ^2 ^ minecraft:diamond_block if block ^-1.5 ^2 ^ minecraft:diamond_block if block ^0.5 ^2 ^ minecraft:diamond_block if block ^-0.5 ^2 ^ minecraft:diamond_block run tag @s add stable
...
execute as @e[type=#tf_portals:p1_can_tp,tag=!p1_teleported] at @s if predicate tf_portals:in_overworld if entity @e[tag=p1_extra,distance=..0.8] at @e[tag=portal1,distance=0..2] rotated as @e[tag=portal1,distance=0..2] in custom:shard run function tf_portals:portal1/teleport_in
execute as @e[type=#tf_portals:p1_can_tp,tag=!p1_teleported] at @s if predicate tf_portals:in_shard if entity @e[tag=p1_extra,distance=..0.8] at @e[tag=portal1,distance=0..2] rotated as @e[tag=portal1,distance=0..2] in minecraft:overworld run function tf_portals:portal1/teleport_out
