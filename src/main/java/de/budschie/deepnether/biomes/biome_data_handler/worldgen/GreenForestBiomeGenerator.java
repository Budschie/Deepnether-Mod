...
public class GreenForestBiomeGenerator implements IBiomeGenerator, ILavaGenerationInterface
{
	int seaLevel;
	...
	public GreenForestBiomeGenerator(int seaLevel, int nearLavaBlockRange, BlockState grassBlock, BlockState groundBlock,
	...
	public GreenForestBiomeGenerator(int nearLavaBlockRange, BlockState grassBlock, BlockState groundBlock,
			BlockState lavaBlock, BlockState nearLavaBlock)
	{
