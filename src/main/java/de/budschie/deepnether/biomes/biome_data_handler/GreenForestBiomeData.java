...
{
	private static final LazyProvider<GreenForestBiomeGenerator> GREEN_FOREST_BIOME = new LazyProvider<GreenForestBiomeGenerator>(() -> 
	{
		GreenForestBiomeGenerator biomeGenerator = new GreenForestBiomeGenerator(8, BlockInit.GREEN_FOREST_FERTILIUM_GRASS_BLOCK.getDefaultState(), BlockInit.FERTILIUM.getDefaultState(), Blocks.LAVA.getDefaultState(), BlockInit.FERTILIUM.getDefaultState());
