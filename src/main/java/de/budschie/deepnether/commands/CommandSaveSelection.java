...
public class CommandSaveSelection
{
	...
	public static void onRightClick(RightClickBlock rightClickevent)
	{
		...
		if(rightClickevent.getPlayer().isShiftKeyDown())
		{
			rightClickevent.getPlayer().sendMessage(new StringTextComponent(TextFormatting.LIGHT_PURPLE + "POS2: " + pos.getX() + " " + pos.getY() + " " + pos.getZ()));
			pos2 = pos;
		}
		else
		{
			rightClickevent.getPlayer().sendMessage(new StringTextComponent(TextFormatting.LIGHT_PURPLE + "POS1: " + pos.getX() + " " + pos.getY() + " " + pos.getZ()));
			pos1 = pos;
		}
	}
